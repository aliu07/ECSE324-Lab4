...
// and returns nothing. Hint: You can implement this function by calling VGA_draw_point_ASM with a color value 
// of zero for every valid location on the screen.
VGA_clear_pixelbuff_ASM:

// This subroutine writes the ASCII code c to the screen at (x, y). The subroutine should check that the 
// coordinates supplied are valid, i.e., x in [0, 79] and y in [0, 59]. Hint: This subroutine should only 
